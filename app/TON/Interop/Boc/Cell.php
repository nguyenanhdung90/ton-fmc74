...
use App\TON\Interop\Boc\Helpers\CellType;
use App\TON\Interop\Boc\Helpers\CellTypeResolver;
use App\TON\Interop\Boc\Helpers\LevelMask;
use App\TON\Interop\Boc\Helpers\MaskResolver;
use App\TON\Interop\Boc\Helpers\TypedArrayHelper;
use App\TON\Interop\Boc\Helpers\BocMagicPrefix;
use App\TON\Interop\Bytes;
use App\TON\Interop\Checksum;
...
class Cell
{
    ...
    private string $type = CellType::ORDINARY;
     ...
     */
    public static function fromBoc($serializedBoc): array
    {
     ...
     * @throws CellException
     */
    public static function oneFromBoc($serializedBoc, bool $isBase64 = false): Cell
    {
     ...
     * @throws CellException
     */
    private static function deserializeBoc($serializedBoc, bool $isBase64 = false): array
    {
